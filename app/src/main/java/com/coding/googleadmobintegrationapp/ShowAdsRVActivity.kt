...
import com.coding.googleadmobintegrationapp.adapters.ProductAdapter
import com.coding.googleadmobintegrationapp.models.Product
import com.coding.googleadmobintegrationapp.models.Rating
import com.coding.googleadmobintegrationapp.rvadapter.AdmobNativeAdAdapter
import org.json.JSONArray

class ShowAdsRVActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_show_ads_rvactivity)
        ...
        val admobNativeAdAdapter = AdmobNativeAdAdapter.Builder.with(
            ...
            productAdapter,
            "custom"  // small, medium, custom
        ).adItemInterval(5).build()

        productRV.adapter = admobNativeAdAdapter
    }
